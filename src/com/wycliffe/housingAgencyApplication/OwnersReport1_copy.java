 ...
 */
public class OwnersReport1_copy  {
    ...
    try{
        ...
        String SQLTotalCom = "select sum(total_commision) from owners";
        rsComputeCom =  stComputeCom.executeQuery(SQLTotalCom);
                
        while(rsComputeCom.next()){
            compute = rsComputeCom.getString("sum(total_commision)");
       ...
       do
        {
                    ...
                    printTable.addCell(currency+rsRpt.getString("total_collection"));
                    printTable.addCell(rsRpt.getString("percent_commision")+"%");
                    printTable.addCell(currency+rsRpt.getString("total_commision"));
       ...
       while(rsRpt.next());
        ...
        pdf.add(printTable);
        Paragraph pgCom =new Paragraph("",boldFont);
        pgCom.add("The Total Commission for Agency:"+compute+"\n");
    ...
    public static void main(String[] args) throws FileNotFoundException, DocumentException , IOException{
        OwnersReport1_copy Obj =  new OwnersReport1_copy();
        Obj.ownersReports();
    }    
}
